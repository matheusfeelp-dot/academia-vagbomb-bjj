export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-0 overflow-hidden rounded-full border border-primary/40 bg-card/95 pr-0 shadow-lg shadow-black/50 backdrop-blur transition-all hover:pr-5 hover:border-primary"
    >
      <span className="relative flex h-14 w-14 shrink-0 items-center justify-center">
        <span className="absolute inset-1 animate-ping rounded-full bg-primary/30" />
        <span className="relative flex h-12 w-12 items-center justify-center rounded-full bg-primary">
          <svg
            viewBox="0 0 24 24"
            className="h-7 w-7 fill-primary-foreground"
            aria-hidden="true"
          >
